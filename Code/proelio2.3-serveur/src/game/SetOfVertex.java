 ...
 */
	 ...
	 */		
		...
		public int[] getNumberOfPawn(Legion emptyLegion, int nbLegion)
		{
			int res[]=new int[nbLegion];
			...
			{
				Vertex vertex=this.element(i);
				if(vertex.legion!=emptyLegion)
					res[vertex.legion.numLegion]++;
			}
			return res;
		}
