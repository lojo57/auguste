 ...
 * 
 *  Here is the matrix when baseHexa=3. We just write the "true" by "T" and "false" by "."
 *  
 *       ...........
 *       ...T.T.T...
 *       ..T.T.T.T..
 ...
 */
	...
	private boolean[][] createMatrix(int baseHexa){
		...
		int xPlat = 4*baseHexa-1;
		int yPlat = 2*baseHexa+1;
...
//To erase angles
	...
	private static int [][][] catalogueDroite(boolean plateau[][])
	{
		...
		//Diagonales "\" : quand i augmente, j augmente.
