...
public class DataGiven {
	 ...
	 */
	public int nbLegion=2;//2 or  4 or 6
	/**
	 * The number of team
	 */
	...
	/**
	 * The array of number of pawn of each player;
	 */
	public  int[] nbPions;
	...
	public final static Legion emptyLegion=new Legion();
	...
	public DataGiven(Broadcast bc)
	{
		broadcast = bc;
	}


	public void computeData(int baseH,int nbLegio, int nbTea)
	{
		baseHexa=baseH;
		nbLegion=nbLegio;
		nbTeam=nbTea;
		nbPions = new int[nbLegion];
